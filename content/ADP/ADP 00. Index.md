...
### ADP 32회
#### 3-1 기본 회귀가정을 검토하라
#### 3-2 변수간 관계를 검토하고 문제점 해결방안 2가지 제시
#### 3-2에서 제안한 것을 반영햐여 문제를 해결하고 적용 결과를 제시
...
#### 7-1 A,B,C,D,E 영업사원의 각 계약 성사 유무 (1:계약 , 0:미계약) 를 나타낸 데이터이다. 영업사원의 평균 계약 성사 건수는 같은지 통계 검정하라
